...
const Trainer = () => {
  const { data: allTrainer = [], refetch } = useQuery({
    queryKey: ['allTrainer'],
    queryFn: () =>
      fetch(`https://perform-tracker-server.vercel.app/trainer`).then(res => res.json()),
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <div>
          ...
          >
            <GrFormAdd className=" bg-white rounded-full text-white mr-3" /> Add Trainer
          </label>
