        ...
        <section className="text-center my-16 mx-auto max-w-screen-xl">
            ...
            <div className="my-6 grid lg:grid-cols-4 md:grid-cols-2 gap-0">
                <div className='my-6 teams'>
                    ...
                    <p className='text-xl font-semibold'>Rofiqul Islam</p>
                    <p>Employer</p>
                </div>
                <div className='my-6 teams'>
                    <div className="avatar relative inline-block">
                    ...
                    <p className='text-xl font-semibold'>Istiq Robin</p>
                    <p>Employer</p>
                </div>
                <div className='my-6 teams'>
                    <div className="avatar relative inline-block">
                    ...
                    <p className='text-xl font-semibold'>Jabrd Mia</p>
                    <p>Employer</p>
                </div>
                <div className='my-6 teams'>
                    <div className="avatar relative inline-block">
                    ...
                    <p className='text-xl font-semibold'>Sumon Kaysar</p>
                    <p>Employer</p>
                </div>
            </div>
        </section>
