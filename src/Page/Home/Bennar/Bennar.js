            ...
            >
                <SwiperSlide>
                    ...
                    <div className='absolute top-[25%] left-[10%] text-white'>
                        ...
                        <h3 className='text-4xl font-semi-bold mt-2'>to take your business further</h3>
                        <Link to='/'
                            className="mt-8 group relative inline-block text-sm font-medium text-white focus:outline-none focus:ring"
                        >
                            <span
                                className="rounded-3xl absolute inset-0 border border-red-600 group-active:border-red-500"
                            ></span>
                            <span
                                className="rounded-3xl block border border-red-600 bg-red-600 px-12 py-3 transition-transform active:border-red-500 active:bg-red-500 group-hover:-translate-x-1 group-hover:-translate-y-1"
                            >
                                REQUEST A MEETING
                            </span>
                        </Link>
