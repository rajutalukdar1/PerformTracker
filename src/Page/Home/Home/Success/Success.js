      ...
      <div className="my-6 grid lg:grid-cols-4 md:grid-cols-2 gap-0">
        <div className="my-6">
          <div className="avatar">
            <div className="w-48 rounded-full">
              <img
                src="https://i.ibb.co/fnjWvW3/christian-buehner-DIt-Ylc26z-VI-unsplash.jpg"
                alt=""
              />
            </div>
          </div>
        ...
        <div className="my-6">
          <div className="avatar">
            <div className="w-48 rounded-full">
              <img
                src="https://i.ibb.co/0B0Smqy/joseph-gonzalez-i-Fg-Rcq-Hznqg-unsplash.jpg"
                alt=""
              />
            </div>
          </div>
        ...
        <div className="my-6">
          <div className="avatar">
            <div className="w-48 rounded-full">
              <img
                src="https://i.ibb.co/Zcyb7dZ/julian-wan-WNo-Ln-Jo7t-S8-unsplash.jpg"
                alt=""
              />
            </div>
          </div>
        ...
        <div className="my-6">
          <div className="avatar">
            <div className="w-48 rounded-full">
              <img
                src="https://i.ibb.co/9ZwQ5Xv/vicky-hladynets-C8-Ta0gw-Pb-Qg-unsplash.jpg"
                alt=""
              />
            </div>
          </div>
